...
<span id='guoqianjiangtmec18'> </span>
- *Wind Turbine Fault Detection Using a Denoising Autoencoder With Temporal Information* [^^^](#returnfault)
    - https://ieeexplore.ieee.org/document/8059861
    - Guoqian Jiang; Ping Xie; Haibo He; Jun Yan
    - IEEE/ASME Transactions on Mechatronics ( Volume: 23, Issue: 1, Feb. 2018) Page(s): 89 - 100
...
<span id='tingtingchen'> </span>
- *Unsupervised Anomaly Detection of Industrial Robots Using Sliding-Window Convolutional Variational Autoencoder* [^^^](#returnfault)
    - https://ieeexplore.ieee.org/document/9023488
    - Tingting Chen; Xueping Liu; Bizhong Xia; Wei Wang; Yongzhi Lai
    - IEEE Access ( Volume: 8) Page(s): 47072 - 47081
...
<span id='xiaolizhao'> </span>
- *Fault Diagnosis Framework of Rolling Bearing Using Adaptive Sparse Contrative Auto-Encoder With Optimized Unsupervised Extreme Learning Machine* [^^^](#returnfault)
    - https://ieeexplore.ieee.org/document/8945331
    - Xiaoli Zhao; Minping Jia; Zheng Liu
    - IEEE Access ( Volume: 8) Page(s): 99154 - 99170
